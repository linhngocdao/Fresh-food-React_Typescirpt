...
const Footer = (props: Props) => {
  return (
    ...
    <div className='flex gap-[100px] justify-center pt-6'>
        ...
        <p className='  pt-[15px] text-slate-600  ease-in-out text-[15px] '>Liên hệ đặt hàng <strong>0123456789</strong></p>
        <p className=' pt-[15px] text-slate-600  ease-in-out text-[15px] '>Thắc mắc đơn hàng <strong>0123456789</strong></p>
        <p className='pt-[15px] text-slate-600  ease-in-out text-[15px] ' >Góp ý, khiếu nại <strong>0123456789</strong></p>
        </div>

        <div>
        <b className='text-[18px]'>Về Sneakers</b>
...
<hr />
  <div className="info text-center pt-3 text-gray-500">
    <p>Copyright by Đào Ngọc Linh © 2022. All rights reserved.</p>
  </div>
      ...
      <footer className="text-center lg:text-left bg-[#f7f7f7] text-gray-600">
        ...
        <div className="mx-6 py-10 text-center md:text-left">
          ...
          ">
            ...
            <div >
              <h6 className="uppercase font-semibold mb-4 ml-[130px] flex justify-center md:justify-start">
                Products
              </h6>
              <p className="mb-4 mr-[23px]">
                <a href="#!" className="text-gray-600">Angular</a>
              </p>
              <p className="mb-4 mr-[40px]">
                <a href="#!" className="text-gray-600">React</a>
              </p>
              <p className="mb-4  mr-[54px]">
                <a href="#!" className="text-gray-600">Vue</a>
              </p>
              <p>
                <a href="#!" className="text-gray-600  mr-[30px]">Laravel</a>
              </p>
            </div>
            <div >
              <h6 className="uppercase font-semibold mb-4 ml-[130px] flex justify-center md:justify-start">
              ...
              <p className="mb-4">
                <a href="#!" className="text-gray-600  mr-[30px]">Pricing</a>
              </p>
              <p className="mb-4">
                <a href="#!" className="text-gray-600  mr-[22px]">Settings</a>
              </p>
              <p className="mb-4">
                <a href="#!" className="text-gray-600  mr-[32px]">Orders</a>
              </p>
              <p>
                <a href="#!" className="text-gray-600  mr-[45px]">Help</a>
              </p>
            </div>
            <div >
